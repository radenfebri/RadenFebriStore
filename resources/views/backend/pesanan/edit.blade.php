                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 align-self-center">
                                                        ...
                                                        <div class="form-group row invoice-note">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" name="message_admin" required placeholder='Notes - For example, "Thank you for doing business with us"' style="height: 88px;">{{ $order->message_admin }}</textarea>
                                                            </div>
                                                        </div>
