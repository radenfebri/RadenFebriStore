                ...
                <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-six">
                        <div class="widget-heading">
                            <h6 class="">{{ Auth::user()->roles->pluck('name')[0] ?? '' }} </h6>
                            ...
                            <div class="meta-info">
                                ...
                                <div class="avatar--group">
                                    ...
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('back') }}/src/assets/img/profile-8.jpeg"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('back') }}/src/assets/img/profile-12.jpeg"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('back') }}/src/assets/img/profile-19.jpeg"/>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-one">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ asset('back') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-two">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ asset('back') }}/src/assets/img/g-8.png" alt="avatar">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="card-bottom-section">
                                ...
                                <div class="img-group">
                                    <img src="{{ asset('back') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                    <img src="{{ asset('back') }}/src/assets/img/profile-6.jpeg" alt="avatar">
                                    <img src="{{ asset('back') }}/src/assets/img/profile-8.jpeg" alt="avatar">
                                    <img src="{{ asset('back') }}/src/assets/img/profile-3.jpeg" alt="avatar">
                                </div>
